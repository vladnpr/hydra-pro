...
Route::group(['middleware' => ['auth', 'verified', 'can:access-combat'], 'prefix' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'vampire', 'as' => 'vampire.'], function () {
        ...
        Route::get('combat_shifts/{id}/spending-report', [\App\Http\Controllers\Vampire\VampireCombatShiftController::class, 'spendingReport'])->name('combat_shifts.spending_report')->where('id', '[0-9]+');
        ...
        Route::group(['middleware' => 'can:manage-vampire'], function () {
            ...
            Route::get('flights/{id}/download', [\App\Http\Controllers\Vampire\VampireFlightController::class, 'downloadVideo'])->name('flights.download')->where('id', '[0-9]+');
    ...
    Route::group(['prefix' => 'air-defence', 'as' => 'air-defence.'], function () {
        ...
        Route::group(['middleware' => 'can:manage-air-defence'], function () {
            ...
            Route::post('combat_shifts/{id}/leave', [\App\Http\Controllers\AirDefence\AirDefenceCombatShiftController::class, 'leave'])->name('combat_shifts.leave')->where('id', '[0-9]+');
