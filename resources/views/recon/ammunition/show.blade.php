        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    <a href="{{ route('recon.ammunition.edit', $ammunition->id) }}" class="btn btn-info">Редагувати</a>
                    <a href="{{ route('recon.ammunition.index') }}" class="btn btn-default float-right">Назад до списку</a>
                </div>
            </div>
        </div>
    </div>
