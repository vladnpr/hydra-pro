...
@section('title', 'Звіт по витратах розвідки')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Звіт по витратах розвідки</h1>
        <div>
...
@section('content')
    <div class="row mb-3 no-print">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('recon.combat_shifts.spending_report', $shift->id) }}" method="GET" class="form-inline">
            ...
            <div class="card">
                <div class="card-body p-5" id="report-content">
                    <div class="report-header mb-4">
                        <h4 class="mb-3">Позиція "{{ $shift->position_name }}" (розвідка)</h4>
