                        ...
                        <tbody>
                            @forelse($drones as $drone)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('ugv.drones.show', ['drone' => $drone->id]) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('ugv.drones.edit', ['drone' => $drone->id]) }}" class="btn btn-info btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            @if(auth()->user()->isAdmin())
                                                <form action="{{ route('ugv.drones.destroy', ['drone' => $drone->id]) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
