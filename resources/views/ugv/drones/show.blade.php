        ...
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Інформація про НРК</h3>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href="{{ route('ugv.drones.edit', ['drone' => $drone->id]) }}" class="btn btn-info">Редагувати</a>
                    <a href="{{ route('ugv.drones.index') }}" class="btn btn-default float-right">Назад до списку</a>
                </div>
            </div>
        </div>
    </div>
