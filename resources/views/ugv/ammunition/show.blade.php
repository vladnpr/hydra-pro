        ...
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    <a href="{{ route('ugv.ammunition.edit', ['ammunition' => $ammunition->id]) }}" class="btn btn-info">Редагувати</a>
                    <a href="{{ route('ugv.ammunition.index') }}" class="btn btn-default float-right">Назад до списку</a>
                </div>
            </div>
        </div>
    </div>
