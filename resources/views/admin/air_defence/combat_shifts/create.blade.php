...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('air-defence.combat_shifts.store') }}" method="POST" id="create-shift-form">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card card-info">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('air-defence.combat_shifts.index') }}" class="btn btn-default float-right">Скасувати</a>
                            </div>
                        </div>
                    </div>
                </div>
