...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('air-defence.combat_shifts.update', $shift->id) }}" method="POST" id="edit-shift-form">
                @csrf
                @method('PUT')
                <input type="hidden" name="request_source" value="admin_edit">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                ...
                                <div id="damaged-drones-container">
                                    @php
                                        $damagedDrones = old('damaged_drones', $shift->damaged_drones);
                                    @endphp
                                    @foreach($damagedDrones as $index => $item)
                                ...
                                <div id="damaged-coils-container">
                                    @php
                                        $damagedCoils = old('damaged_coils', $shift->damaged_coils);
                                    @endphp
                                    @foreach($damagedCoils as $index => $item)
                                        <div class="damaged-item row mb-2">
                                            <div class="col-md-7">
                    ...
                    <div class="col-md-6">
                        {{-- <div class="card card-info">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('air-defence.combat_shifts.show', $shift->id) }}" class="btn btn-default float-right">Скасувати</a>
                            </div>
                        </div> --}}
                        <div class="card card-primary">
                            <div class="card-footer">
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            let damagedDroneIndex = {{ is_array($damagedDrones) ? count($damagedDrones) : 0 }};
            let damagedCoilIndex = {{ is_array($damagedCoils) ? count($damagedCoils) : 0 }};
