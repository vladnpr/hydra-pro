...
@section('title', 'Звіт по витратах Vampire')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Звіт по витратах Vampire</h1>
        <div>
...
@section('content')
    <div class="row mb-3 no-print">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('vampire.combat_shifts.spending_report', $shift->id) }}" method="GET" class="form-inline">
