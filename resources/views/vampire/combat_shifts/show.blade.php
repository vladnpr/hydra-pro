            ...
            <div class="card">
                <div class="card-header p-2">
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a class="nav-link active" href="#flights" data-toggle="tab">Вильоти</a></li>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="active tab-pane" id="flights">
                            ...
                            @forelse($shift->vampire_flights as $date => $dayFlights)
                                            ...
                                            <table class="table table-sm table-striped mb-0">
                                                ...
                                                <tbody>
                                                    @foreach($dayFlights as $flight)
                                                        <tr>
                                                            <td class="pl-3 text-nowrap">{{ \Carbon\Carbon::parse($flight['start_time'])->format('H:i') }}</td>
                                                            <td>{{ $flight['drone_name'] }} <small class="text-muted d-none d-md-inline">({{ $flight['drone_serial'] ?? '-' }})</small></td>
                                                            <td><strong>{{ $flight['position_name'] }}</strong></td>
                                                            <td class="d-none d-lg-table-cell small">{{ $flight['coordinates'] }}</td>
                                                                        ...
                                                                        <div class="modal-dialog modal-lg" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title">Відео вильоту ({{ \Carbon\Carbon::parse($flight['start_time'])->format('H:i') }})</h5>
                                                            ...
                                                            <td class="d-none d-lg-table-cell small">{{ $flight['comment'] }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
